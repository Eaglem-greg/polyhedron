...
class TestVoid(unittest.TestCase):
    ...
    def test_check(self):
        f = Facet([R3(-2.0, 2.0, 0.0), R3(-2.0, -2.0, 0.0), R3(-4.0, 0.0, 0.0), R3(0.0, 0.0, 0.0)])
        self.assertTrue(f.check())

    def test_check1(self):
        f = Facet([R3(3.0, 2.0, 0.0), R3(-2.0, -2.0, 0.0), R3(-4.0, 0.0, 0.0), R3(0.0, 0.0, 0.0)])
    ...
    def test_area1(self):
        f = Facet([R3(-2.0, 2.0, 0.0), R3(-2.0, -2.0, 0.0)])
        expected_area = 0.0
        self.assertTrue(isclose(f.area(), expected_area))